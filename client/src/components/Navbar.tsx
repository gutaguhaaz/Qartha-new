              ...
              >
                {getProjectsForCluster(selectedCluster).map((project) => (
                  <option key={project} value={project}>
                    {project === 'trinity' ? 'Sabinas Project' : project.charAt(0).toUpperCase() + project.slice(1) + ' Project'}
                  </option>
                ))}
              </select>
            </div>
