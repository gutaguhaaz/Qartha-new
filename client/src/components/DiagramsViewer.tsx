...
export default function DiagramsViewer({ item }: DiagramsViewerProps) {
  ...
  if (item) {
    if (typeof item === "string") {
      ...
      items = item
        .map((i) => {
          if (typeof i === "string") {
            // Convert simple string paths to full URLs
            const url = i.startsWith("/static/") ? i : `/static/${i}`;
            return { url };
          }
  ...
  const handleDownload = () => {
    ...
    link.download = `diagram-${currentIndex + 1}`;
    link.click();
  };
  ...
  return (
    ...
    >
          ...
          <div className="flex items-center space-x-2">
            {items.length > 1 && (
              <>
                <button
                  ...
                  data-testid="button-previous-diagram"
                >
                ...
                <button
                  onClick={handleNext}
                  className={`px-3 py-1 rounded-md text-sm transition-colors ${isFullscreen ? "bg-gray-700 hover:bg-gray-600 text-white" : "bg-secondary text-secondary-foreground hover:bg-secondary/80"}`}
                  data-testid="button-next-diagram"
                >
            ...
            {!isFullscreen && (
              <>
                ...
                <span
                  className="text-sm text-muted-foreground min-w-12 text-center"
              ...
              >
                <img
                  ...
                  onError={(e) => {
                    ...
                    target.src =
                      "data:image/svg+xml;base64,PHN2ZyB3aWR0aD0iNjQiIGhlaWdodD0iNDgiIHZpZXdCb3g9IjAgMCA2NCA0OCIgZmlsbD0ibm9uZSIgeG1sbnM9Imh0dHA6Ly93d3cudzMub3JnLzIwMDAvc3ZnIj4KPHJlY3Qgd2lkdGg9IjY0IiBoZWlnaHQ9IjQ4IiBmaWxsPSIjRjNGNEY2Ii8+CjxwYXRoIGQ9Ik0yOCAyN2m্র2LjUgMjQuNUwzNi41IDMyLjVIMjhWMjRaWiIgZmlsbD0iIzlDQTNBRiIvPgo8L3N2Zz4K";
                  }}
                />
              </button>
            ))}
      ...
      <div
        ...
        data-testid="diagrams-container"
      >
        <div
        ...
        >
          <img
            ...
            onError={(e) => {
              console.error(`Failed to load diagram image: ${correctedUrl}`);
              const target = e.target as HTMLImageElement;
