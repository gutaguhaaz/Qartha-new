...
/**
 * DO NOT EDIT: SVG protegido.
 * Si necesitas cambios, hazlos aquí y evita que el Asistente toque el resto del proyecto.
 */
// eslint-disable-next-line @typescript-eslint/no-unused-vars
const Logo: React.FC<LogoProps> = ({ height = 45, className = "" }) => {
  return (
